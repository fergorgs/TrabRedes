...
all: client/app.cpp client/Client.cpp utils/RFCprotocol.cpp server/hub.cpp
	g++ -o bin/app client/app.cpp client/Client.cpp utils/RFCprotocol.cpp  $(libs) $(version) -Wno-deprecated-declarations 
